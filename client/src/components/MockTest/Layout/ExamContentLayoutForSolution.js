...
//     console.log('💥 val:', val, 'isSelected:', isSelected, 'isCorrect:', isCorrect);
  
//     if (isSelected && isCorrect) return 'option-box correct';
//     if (isSelected && !isCorrect) return 'option-box incorrect';
//     if (!isSelected && isCorrect) return 'option-box highlight-correct';
//     return 'option-box';
//   };
